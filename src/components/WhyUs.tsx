    ...
    <section id="why-us" className="py-24 bg-primary text-primary-foreground">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div>
            <p className="text-primary-foreground/50 text-sm tracking-[0.3em] uppercase mb-4">Наши преимущества</p>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight">Почему выбирают нас</h2>
          </div>
          <a
            href="#contact"
            className="inline-flex items-center gap-2 text-sm bg-primary-foreground text-primary font-medium px-6 py-3 rounded-full hover:opacity-90 transition-opacity"
          >
            Обсудить проект
          </a>
        </div>
