...
export const projects = [
  ...
  },
  {
    ...
    description: "Бункер у моря с усиленной защитой от солёного воздуха и влажности. Специальное антикоррозийное покрытие всех металлических конструкций. Особая система осушения воздуха поддерживает оптимальный микроклимат в условиях морского климата. Объект рассчитан на автономность до 9 месяцев.",
    area: "120 м²",
    duration: "50 дней",
    budget: "от 18,7 млн ₽",
  },
  {
    ...
    description: "Промышленный укрывной комплекс с системой принудительной вентиляции повышенной мощности и двойным шлюзованием. Рассчитан на длительное пребывание большой группы в условиях химического заражения. Интегрирована система мониторинга внешней среды с автоматическим переключением режимов защиты.",
    area: "320 м²",
    duration: "105 дней",
    budget: "от 65,4 млн ₽",
  },
  {
    id: 13,
    title: "Резиденция «Гелиос»",
    category: "Экологичный объект · 8 чел.",
    ...
    description: "Полностью автономный бункер с солнечной генерацией 20 кВт и системой хранения энергии. Тепловые насосы обеспечивают отопление и кондиционирование. Органический сад под фитолампами и система водооборота делают объект самодостаточным на неограниченный срок при наличии солнечного света снаружи.",
    area: "155 м²",
    duration: "65 дней",
    budget: "от 28,3 млн ₽",
  },
