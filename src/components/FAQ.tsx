    ...
    <section id="faq" className="py-16 md:py-24">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-10 md:mb-16">
          <p className="text-muted-foreground text-sm tracking-[0.3em] uppercase mb-4 md:mb-6">Вопросы</p>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium leading-[1.15] tracking-tight mb-4 text-balance lg:text-6xl">
            Частые вопросы
          </h2>
        </div>
        ...
        <div>
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-border">
              ...
              >
                <p className="text-muted-foreground leading-relaxed pb-6 pr-4 md:pr-12 text-sm md:text-base">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
